    ...
    >
      <DrawerBody>
        ...
        <a
          ...
          target="blank"
        >
          <BsLinkedin style={{ color: "#007BB5", marginRight: "20px" }} />
          Linkedin
        </a>
        <a href="https://github.com/GabrielH1010" target="blank">
          <BsGithub style={{ color: "#fff", marginRight: "20px" }} />
          GitHub
        </a>
        <a
          ...
          target="blank"
        >
          <BsWhatsapp style={{ color: "#61FD7D", marginRight: "20px" }} />
          Whatsapp
        </a>
        <a href="mailto:gabrielhdeoliveira17@gmail.com? " target="blank">
          <AiOutlineMail style={{ color: "#F84437", marginRight: "20px" }} />
          E-mail
        </a>
      </DrawerBody>
    </SwipeableDrawer>
  ...
  return (
    <div className="App">
          ...
          <div className="menu">
            ...
            <div className="areaButton">
              <button
                onClick={() =>
                  navTo(
                    "http://api.whatsapp.com/send?1=pt_BR&phone=5534998985764"
                  )
                }
              >
                Contacts
      ...
      <Fade left>
        <Section
          id="WorkExperience"
          style={{ backgroundColor: "#000", height: "105vh" }}
        >
          <div class="containerTopic">
            <Topic>Work Experience</Topic>
            <Hr />
            <SubTopic>Minha trajetória profissional.</SubTopic>
              ...
              <Timeline position="alternate">
                ...
                <TimelineItem>
                  ...
                  <TimelineContent sx={{ py: "5px", px: 2 }}>
                    ...
                    <p className="acting">
                      Atuava como QA garantindo a qualidade do produto
                      realizando testes.
                    </p>
                  </TimelineContent>
                </TimelineItem>
                ...
                <TimelineItem>
                  ...
                  <TimelineContent sx={{ py: "5px", px: 2 }}>
                    <h3 className="company">
                      Água Branca Distribuidoras de bebidas
                    </h3>
                    <p className="acting">
                      Atuava no setor Fiscal na emissão e lançamento de notas
                      fiscais.
                    </p>
                  </TimelineContent>
                </TimelineItem>
      ...
      <Fade left>
        <Section id="About">
          <div class="containerTopic">
            ...
            <Hr />
            <SubTopic>
              Um pouco mais sobre minha trajetória até aqui e meus objetivos
              profissionais.
            </SubTopic>
            <div className="profile">
              ...
              <div className="description" style={{ backgroundColor: "#000" }}>
                <h3>
                  "Meu nome é Gabriel e sou desenvolvedor Front-end. Tenho
                  contato com a tecnologia desde os meus 12 anos. Meu primeiro
                  computador me despertou a curiosidade de como tudo aquilo
                  funcionava, desde então comecei a desmontar, entender as peças
                  e montar novamente o computador.
                </h3>
                <h3>
                  Quando terminei o ensino médio consegui bolsa na faculdade e
                  iniciei o curso de Análise e Desenvolvimento de Sistemas, não
                  satisfeito somente com as matérias da faculdade fiz alguns
                  cursos por fora e iniciei minha carreira na área de TI como
                  Quality Assurance e posteriormente comecei a estudar
                  Front-end, que é a área que atuo. Continuo aprimorando meus
                  conhecimentos atuais e disposto a aprender novas tecnologias,
                  para assim, um dia poder repassar os meus conhecimentos.
                </h3>
              </div>
            </div>
          </div>
